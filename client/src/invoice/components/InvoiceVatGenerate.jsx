...
const InvoiceVatGenerate = ({ invoiceData, onClose }) => {
  ...
  // Transform invoice data to invoice format
  ...
  const vat = invoiceTableData.reduce(
      ...
      <div className="max-w-4xl mx-auto bg-white border-2 border-black">
        ...
        <div className="border-b-2 border-black">
          ...
          <div className="text-center py-2 bg-gray-100">
            <h2 className="text-xl font-bold">INVOICE WITH VAT</h2>
          </div>
        </div>
...
export default InvoiceVatGenerate;